...
import { Plus, UserCheck, UserX, KeyRound, Loader2, X } from 'lucide-react'
...
export default function UsersManager({ users }: { users: Profile[] }) {
  ...
  return (
    <>
                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    <button
                      ...
                      className={[
                        ...
                        user.active ? 'text-green-500 hover:text-red-500' : 'text-gray-400 hover:text-green-500',
                      ].join(' ')}
                    >
      ...
      {showCreate && <CreateUserModal onClose={() => setShowCreate(false)} onCreated={() => { setShowCreate(false); router.refresh() }} />}
    </>
  )
}
